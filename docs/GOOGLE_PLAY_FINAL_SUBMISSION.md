...
Exact values to enter in Play Console. The live backend host is `mahmadmurodov-tajikshop.hf.space` — the URLs below are ready to copy. Open each one in a browser once after the latest `main` is deployed and confirm it loads over HTTPS before submitting.
...
| Privacy Policy URL | `https://mahmadmurodov-tajikshop.hf.space/privacy` |
| Delete Account URL | `https://mahmadmurodov-tajikshop.hf.space/delete-account` |
| Terms URL | `https://mahmadmurodov-tajikshop.hf.space/terms` |
| Backend (production) | `https://mahmadmurodov-tajikshop.hf.space/api/v1` |
| Support email (Play requires one) | `ehsonmahmadmurodov@gmail.com` |
...
3. **App content → Privacy policy**: `https://mahmadmurodov-tajikshop.hf.space/privacy`.
...
9. **App content → Account deletion**: URL `https://mahmadmurodov-tajikshop.hf.space/delete-account` (and note in‑app deletion exists).
