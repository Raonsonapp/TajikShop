...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    errorBuilder: (_, __) => const Scaffold(
      ...
      body: Center(child: Text('Саҳифа ёфт нашуд', style: TextStyle(color: Colors.white)))),
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(path: RouteNames.home, pageBuilder: (_, __) => const NoTransitionPage(child: HomeScreen())),
          GoRoute(path: RouteNames.favorites, pageBuilder: (_, __) => const NoTransitionPage(child: FavoritesScreen())),
          GoRoute(path: RouteNames.upload, pageBuilder: (_, __) => const NoTransitionPage(child: UploadScreen())),
          GoRoute(path: RouteNames.cart, pageBuilder: (_, __) => const NoTransitionPage(child: CartScreen())),
          GoRoute(path: RouteNames.profile, pageBuilder: (_, __) => const NoTransitionPage(child: ProfileScreen())),
        ],
      ),
    ],
  );
