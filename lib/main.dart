...
// FIX: main() sync — ҳеҷ await нест → ANR нест
void main() {
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppL10n> {
  ...
  @override bool isSupported(Locale l) => ['tg','ru','en'].contains(l.languageCode);
  @override Future<AppL10n> load(Locale l) async => AppL10n(l.languageCode);
