              ...
              p.images.isNotEmpty
                  ? PageView.builder(
                      ...
                      itemBuilder: (_, i) => CachedNetworkImage(
                        ...
                        errorWidget: (_, __, ___) => Container(color: context.pal.surface,
                          child: Icon(Icons.image_outlined, color: context.pal.textMuted, size: 60))))
                  : Container(color: context.pal.surface,
                      child: Icon(Icons.image_outlined, color: context.pal.textMuted, size: 60)),
          ...
          child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(p.title, style: TextStyle(
                  color: context.pal.textPrimary, fontSize: 22, fontWeight: FontWeight.w700)),
              if (p.isFlashSale) ...[
              ...
              Row(children: [
                ...
                if (p.oldPrice != null) ...[
                  ...
                  Text('${p.oldPrice!.toStringAsFixed(0)} сом.',
                      style: TextStyle(color: context.pal.textMuted, fontSize: 16,
                ...
                Wrap(spacing: 8, runSpacing: 8, children: p.variants.map((v) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: sel ? AppColors.primary.withValues(alpha: 0.15) : context.pal.card,
  ...
  Widget _ratingSummary(ProductModel p, double avg, Widget trailing) {
    ...
    return Row(children: [
      Text(value.toStringAsFixed(1),
          style: TextStyle(color: context.pal.textPrimary, fontSize: 28, fontWeight: FontWeight.w800)),
      const SizedBox(width: 8),
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          Center(child: Container(width: 40, height: 4,
              decoration: BoxDecoration(color: context.pal.border, borderRadius: BorderRadius.circular(2)))),
          const SizedBox(height: 16),
          Text(title, style: TextStyle(color: context.pal.textPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
          const SizedBox(height: 16),
          Container(
...
class _ReviewTileState extends ConsumerState<_ReviewTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          CircleAvatar(radius: 14, backgroundColor: context.pal.surface,
        ...
        if (r.comment.isNotEmpty) ...[
          const SizedBox(height: 4),
          Text(r.comment, style: TextStyle(color: context.pal.textSecondary, fontSize: 13, height: 1.4)),
        ],
        const SizedBox(height: 6),
        GestureDetector(
          onTap: _toggle,
